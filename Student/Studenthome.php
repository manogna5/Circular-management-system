...
<div id="header-wrapper">
	<div id="header" class="container">
		<div id="logo">
                       <h6><li><?php echo "<font color='white'>".$_SESSION['sess_user']."</font><br><br>";?></li></h6>
...
<div id="page-wrapper">
	<div id="welcome" class="container">
		...
		<p>You can view Sports,Academic,Timetables.Click on search to search a circular.Click on others to view other circulars Have fun :) </p>
	</div>
</div>
<div class="wrapper">
	<div id="three-column" class="container">
		...
		<div id="tbox1">
			...
			<p>This allows you to view all sports circulars.Click here to view and download all Sports circulars.</p>
			<a href="Sports.php" class="button">Click here</a> </div>
		<div id="tbox2">
			<div class="title">
				<h2>Academic</h2>
			</div>
			<p>This allows you to view all Academic circulars.Click here to view and download all Academic circulars.</p>
			<a href="Academic.php" class="button">Click here</a> </div>
		<div id="tbox3">
			<div class="title">
				<h2>Timetables</h2>
			</div>
			<p>This allows you to view all exam schedules and timetables.Click here to view and download all timetables.</p>
